		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Monitor de Royalties",
									"targetURL": "#royaltieszroyalties-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"royaltieszroyalties-display": {
								"semanticObject": "royaltieszroyalties",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=royalties.zroyalties",
									"url": sap.ui.require.toUrl("royalties/zroyalties")
								}
							}
						}
					}
